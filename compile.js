...
const output = solc.compile(exhibitionSource.toString(), 1).contracts;
console.log('-- ABI --')
console.log(output[":Exhibition"].interface);
console.log('-- BYTECODE --')
console.log(output[":Exhibition"].bytecode);
// CONTRATO
//console.log(output[":Exhibition"])
